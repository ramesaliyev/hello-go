...
//  Timers are for when you want to do something once in the future - tickers are for when you
// want to do something repeatedly at regular intervals. Here’s an example of a ticker that
