...
func main() {
	...
	// c1 after 2s. Note that the channel is buffered, so the send in the goroutine is nonblocking.
	...
	// Since select proceeds with the first receive that’s ready, we’ll take the timeout case if the
