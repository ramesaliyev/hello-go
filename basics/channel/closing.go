...
func main() {
	...
	// Reading from a closed channel succeeds immediately, returning the zero value of
	// the underlying type. The optional second return value is true if the value
