...
// keys. This function has two type parameters - K and V; K has the comparable constraint, meaning
// that we can compare values of this type with the == and != operators. This is required for map
// keys in Go. V has the any constraint, meaning that it’s not restricted in any way (any is an
// alias for interface{}).
